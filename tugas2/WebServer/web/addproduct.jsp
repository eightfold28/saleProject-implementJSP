...
<html>
    ...
    <body>
        <jsp:include page="header.jsp" >
            <jsp:param name="header_addproduct_class" value="active" />
        </jsp:include>
        ...
        <div class="product">
            <form name="addproduct" action="./AddProduct" method="post" onsubmit="return validasi();" enctype="multipart/form-data">
